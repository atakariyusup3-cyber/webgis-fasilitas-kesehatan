...
<div class="container">
    ...
    <h3 class="mb-3">🏥 Data Puskesmas</h3>

    <a href="/puskesmas/create" class="btn btn-success mb-3">
        ➕ Tambah Puskesmas
    </a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="/puskesmas/{{ $item->id }}" 
                               class="btn btn-info btn-sm mb-1">
                                Detail
                            </a>

                            <form action="/puskesmas/{{ $item->id }}" 
                                  method="POST"
    ...
    <div class="card shadow-sm mb-3">
        <div class="card-header fw-bold">🗺️ Peta Lokasi Puskesmas</div>
        <div class="card-body">
            <div id="map"></div>
        </div>
    </div>
